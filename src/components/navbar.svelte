...
>
	...
	<div class="cta_nav">
		...
		><button
			class="bg-y20c1 from-20% to-y20c2 hover:bg-y20c1/60 hover:to-y20c2/60 transition-all  flex gap-2 rounded-lg bg-gradient-to-r  px-5 py-3 font-semibold text-white hover:opacity-90"
